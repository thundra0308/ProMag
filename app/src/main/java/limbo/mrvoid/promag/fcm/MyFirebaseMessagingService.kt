package limbo.mrvoid.promag.fcm
...
import limbo.mrvoid.promag.activities.MainActivity
import limbo.mrvoid.promag.activities.SignInActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?) {
        ...
        val sharedPreferences =
            this.getSharedPreferences(Constants.PROMAG_PREFRENCES, Context.MODE_PRIVATE)
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.ic_notiandro)
